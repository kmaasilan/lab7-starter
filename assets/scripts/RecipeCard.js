...
class RecipeCard extends HTMLElement {
	...
	constructor() {
		...
		let shdwEl = this.attachShadow({mode: 'open'});
		...
		shdwEl.append(styles);
		shdwEl.append(markup);
	}
	...
	set data(data) {
		...
		let addedArticle = this.shadowRoot.querySelector('article');   //?
		//let addedArticle = articles[articles.length];
		...
		addedArticle.innerHTML =   `<img src="${data["imgSrc"]}" alt="${data["imgAlt"]}">
									<p class="title">
